  ...
  async function callOpenAIAPI() {
    ...
    // What is the sentiment of this tweet with a value between 0 and 10 (10 being its very positive)? 
        ...
        const APIBody = {
            ...
            "prompt": "Extract ATS keywords from the following text:  " + tweet,
            "temperature": 0,
            "max_tokens": 140,
            "top_p": 1.0,
      ...
      <div className="SectionTwo">
        <div>
          <textarea
            ...
            placeholder='Paste job description here to extract ATS keywords'
            style={{
        ...
        <div >
          <Button className = 'btn btn-light m-2' onClick={callOpenAIAPI}>Extract ATS keywords</Button>
          <Button className='btn btn-light m-2' onClick={(e) => CopyToClipboard(e.target)}>Copy ATS keywords to Clipboard</Button>

          {sentiment !== "" ?
            <h3> {sentiment}</h3>  
            :
            <h3> ATS Keywords will be shown here</h3>
          }
        </div>
      </div>
    )
